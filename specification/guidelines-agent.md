...
grep -c "^@agent_model\|^@agent_config\|^@prompt_section" assets/<asset-name>/app/agent.py  # must return 4 (one @agent_model, two @agent_config for temperature and TTL(agent memory), one @prompt_section)
